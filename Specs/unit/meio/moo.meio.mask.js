...
describe('Unit Tests and some simple user emulated', {
	...
	'should mask a string with the fixed mask type option': function(){
		value_of('12121212'.meiomask('Fixed', 'Date')).should_be('12/12/1212');
	},
	
	'should mask a string with the reverse.dollar mask': function(){
		value_of('12121212'.meiomask('reverse.dollar')).should_be('12,121,212.00');
	},
	...
	'should unmask the passed string': function(){
		value_of('12/12/2000'.meiounmask('Fixed', 'Date')).should_be('12122000');
	},
